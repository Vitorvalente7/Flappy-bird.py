import pygame
import os   #Serve para pegar as imagens da pasta
import random

# inicializar o mixer.
pygame.mixer.init()

TELA_LARGURA = 500          #constante tem que ser em letra maiuscula
TELA_ALTURA = 800
...
#classes, tudo que tem movimentos e caracteristicas tem que ter classes: abaixo
...
class Passaro():
    ...
    #outro metodo
    # somando no eixo x anda para frente 
    #se somar no eixo y anda para baixo se diminuir anda para cima
    ...
    def mover(self):
        ...
        self.tempo += 1
        deslocamento = 1.5 * (self.tempo**2) + self.velocidade * self.tempo #calculo para o salto longo
    ...
    def desenhar(self, tela):
        ...
        if self.contagem_imagem < self.TEMPO_ROTACAO:
            self.imagem = self.IMGS[0]
        elif self.contagem_imagem < self.TEMPO_ROTACAO*2:
        ...
        tela.blit(imagem_rotacionada, retangulo.topleft)  #para desenhar la dentro

    def get_mask(self):         #mask cria varios quadrados dentro do retangulo, é um metodo dentro do pygame para quando houver uma colisao. Ele vai mapear o retangulo, serve para tornar mais real.
...
class Cano():
    ...
    def colidir(self, passaro):
        ...
        distancia_topo = (self.x - passaro.x, self.pos_topo - round(passaro.y)) #round pega a posição que estiver na hora.
